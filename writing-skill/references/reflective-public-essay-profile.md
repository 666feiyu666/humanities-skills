...
Write as a reflective companion who takes everyday frustration seriously and then changes the conceptual frame. Keep the tone warm, intellectually alert, and slightly conversational. Let philosophy clarify ordinary life rather than decorate it.

The writing has three simultaneous qualities:

- **Reflective**: begin from a familiar experience and ask what it reveals about how people understand themselves.
- **Critical**: locate the social norm, hidden premise, or form of self-judgment that makes the experience heavier.
- **Philosophical**: introduce a distinction that changes the level of the question and supports a more precise judgment.
...
3. Lay out two reasonable positions without caricature.
4. Show the premise they share.
5. Introduce a thinker as a way to redescribe the problem.
6. Test the redescription through one concrete practice.
...
- Heavy: `这不是放弃成长，也不是否定努力，而是拒绝成为超人。`
- Lighter: `这种选择仍然包含成长与努力，只把成长放回有限之人的尺度。`

- Heavy: `向前并不只是继续走下去，也不只是承认停顿。`
- Lighter: `向前首先指生活之线仍在与世界的缠绕中生成。`

- Heavy: `痛苦并不是一个对象，而是一种经验。`
- Lighter: `痛苦首先是一种让人的存在状态显露出来的经验。`
...
- State what problem the thinker helps solve.
- Explain the concept in the essay's own language before expanding it.
- Distinguish the source's position from the essay's extension: `在 X 这里`, `借助这一分析`, `本文进一步关心`.
- Preserve names, titles, quotations, citations, and page numbers exactly as supplied.
- Mark `[需核对原文]`, `[需引文]`, or `[这一推论需要论证]` when support is missing.
- Never fabricate a source-compatible sentence simply because it sounds plausible.
